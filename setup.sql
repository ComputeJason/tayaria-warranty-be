...
-- Insert test claims
INSERT INTO claims (shop_id, warranty_id, customer_name, phone_number, email, car_plate, status, rejection_reason, supporting_doc_url, date_settled) VALUES
-- Unacknowledged claims (no warranty_id tagged yet)
((SELECT id FROM shops WHERE username = 'testshop1'), NULL, 'John Doe', '+60123456789', 'john@example.com', 'ABC1234', 'unacknowledged', NULL, NULL, NULL),
((SELECT id FROM shops WHERE username = 'testshop2'), NULL, 'Tom Brown', '+60123456703', 'tom@example.com', 'JKL202', 'unacknowledged', NULL, NULL, NULL),
((SELECT id FROM shops WHERE username = 'testshop3'), NULL, 'Lisa Wong', '+60123456704', 'lisa@example.com', 'MNO303', 'unacknowledged', NULL, NULL, NULL),

-- Pending claims (no warranty_id tagged yet)
((SELECT id FROM shops WHERE username = 'testshop1'), NULL, 'Jane Smith', '+60123456790', 'jane@example.com', 'XYZ5678', 'pending', NULL, NULL, NULL),
((SELECT id FROM shops WHERE username = 'testshop2'), NULL, 'Tom Brown', '+60123456703', 'tom@example.com', 'JKL202', 'pending', NULL, NULL, NULL),
((SELECT id FROM shops WHERE username = 'testshop3'), NULL, 'Lisa Wong', '+60123456704', 'lisa@example.com', 'MNO303', 'pending', NULL, NULL, NULL),

-- Approved claims (must have warranty_id tagged)
((SELECT id FROM shops WHERE username = 'testshop1'), (SELECT id FROM warranties WHERE car_plate = 'DEF9012'), 'Bob Johnson', '+60123456791', 'bob@example.com', 'DEF9012', 'approved', NULL, NULL, CURRENT_TIMESTAMP - INTERVAL '5 days'),
((SELECT id FROM shops WHERE username = 'testshop2'), (SELECT id FROM warranties WHERE car_plate = 'PQR404'), 'Emma Davis', '+60123456705', 'emma@example.com', 'PQR404', 'approved', NULL, NULL, CURRENT_TIMESTAMP - INTERVAL '3 days'),
((SELECT id FROM shops WHERE username = 'testshop3'), (SELECT id FROM warranties WHERE car_plate = 'STU505'), 'Alex Tan', '+60123456706', 'alex@example.com', 'STU505', 'approved', NULL, NULL, CURRENT_TIMESTAMP - INTERVAL '1 day'),

-- Rejected claims (no warranty_id needed)
((SELECT id FROM shops WHERE username = 'testshop1'), NULL, 'David Wilson', '+60123456707', 'david@example.com', 'ABC1234', 'rejected', 'Mechanical failure', NULL, CURRENT_TIMESTAMP - INTERVAL '7 days'),
((SELECT id FROM shops WHERE username = 'testshop2'), NULL, 'Grace Lee', '+60123456708', 'grace@example.com', 'XYZ5678', 'rejected', 'Mechanical failure', NULL, CURRENT_TIMESTAMP - INTERVAL '6 days'),
((SELECT id FROM shops WHERE username = 'testshop3'), NULL, 'Ryan Lim', '+60123456709', 'ryan@example.com', 'DEF9012', 'rejected', 'Mechanical failure', NULL, CURRENT_TIMESTAMP - INTERVAL '4 days');
